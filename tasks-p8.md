...
- [ ] LT-06 定义跨会话交接字段 <!-- files: docs/claude/standards.md --> <!-- context: 责任角色=PM/QA；输入=阶段性压缩、清上下文、换会话继续执行；输出=handoff 字段规则；依赖关系=依赖 LT-01；完成标准=handoff 能说明当前状态、下一步、阻塞项、需重读文件和最近验证结果 --> <!-- order: 依赖长任务字段标准 -->
