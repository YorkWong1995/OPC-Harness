...
- [ ] LT-03 定义任务前置读取规则 <!-- files: docs/claude/standards.md --> <!-- context: 责任角色=Architect/QA；输入=有前置依赖的任务、换会话继续任务场景；输出=read_before_start 字段规则；依赖关系=依赖 LT-01；完成标准=规则明确继续任务前必须读取任务条目、依赖产物、相关文件、pending diff 或验收记录 --> <!-- order: 依赖长任务字段标准 -->
