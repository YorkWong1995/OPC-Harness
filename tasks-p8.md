...
- [ ] LT-10 更新 task-spec 输出示例 <!-- files: .claude/skills/task-spec/SKILL.md --> <!-- context: 责任角色=QA；输入=新字段格式、现有 task-spec 示例；输出=包含完整长任务字段的示例任务条目；依赖关系=依赖 LT-07 到 LT-09；完成标准=至少包含 1 个无依赖任务示例和 1 个有前置依赖任务示例 --> <!-- order: 依赖 task-spec 规则更新 -->
